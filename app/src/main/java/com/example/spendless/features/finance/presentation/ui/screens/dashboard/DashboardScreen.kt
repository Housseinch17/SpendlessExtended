...
fun DashboardScreen(
    ...
    //disposable effect used here because after leaving this screen/composable
    //the onDispose will work which will re-set status bar to the default color
    //which is the same for all other screens
    DisposableEffect(Unit) {
        activity.enableEdgeToEdge(
            statusBarStyle = SystemBarStyle.dark(scrim = whiteColor)
        )
        onDispose {
            activity.enableEdgeToEdge(
                    ...
                    Column(
                        ...
                        DashboardBottom(
                            ...
                            onSelectTransaction = { transactionItem ->
                                dashboardActions(
                                    DashboardActions.SelectedTransaction(
                                        transactionItem
                                    )
                                )
                            },
